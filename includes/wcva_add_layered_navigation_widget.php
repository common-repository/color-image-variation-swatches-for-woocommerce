...
class wcva_swatches_widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			esc_html__('WooSwatches Filter', 'color-image-variation-swatches-for-woocommerce'), // Name
			array('description' => esc_html__( 'WooSwatches color/image swatches filter widget', 'color-image-variation-swatches-for-woocommerce' ),) // Args
		);
	}
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'wcva_widget_title' ); ?>"><?php echo esc_html__( 'Title','color-image-variation-swatches-for-woocommerce' ); ?></label>
			<input class="widefat " id="<?php echo $this->get_field_id( 'wcva_widget_title' ); ?>" name="<?php echo $this->get_field_name( 'wcva_widget_title' ); ?>" type="text" value="<?php if (isset($instance['wcva_widget_title'])) { echo $instance['wcva_widget_title']; } else { echo esc_html__( 'Filter by','color-image-variation-swatches-for-woocommerce' ); } ?> ">
		</p>
		
		<p>
		    <label for="<?php echo $this->get_field_id( 'filter_attribute' ); ?>"><?php echo esc_html__( 'Attribute','color-image-variation-swatches-for-woocommerce' ); ?></label>
		...
		<p>
		    <label for="<?php echo $this->get_field_id( 'query_type' ); ?>"><?php echo esc_html__( 'Query type','color-image-variation-swatches-for-woocommerce' ); ?></label>
			<select class="widefat" id="<?php echo $this->get_field_id( 'query_type' ); ?>" name="<?php echo $this->get_field_name( 'query_type' ); ?>">
		      <option value="and" <?php if (isset($instance[ 'query_type' ]) && $instance[ 'query_type' ] == "and") { echo 'selected'; } ?>><?php echo esc_html__('AND','color-image-variation-swatches-for-woocommerce'); ?></option>
			  <option value="or" <?php if (isset($instance[ 'query_type' ]) && $instance[ 'query_type' ] == "or") { echo 'selected'; } ?>><?php echo esc_html__('OR','color-image-variation-swatches-for-woocommerce'); ?></option>
			</select>
		</p>
