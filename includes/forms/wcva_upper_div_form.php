<div class="wcva-upper-div">
    <table class="widefat" width="100%" style="border:none;">
		<tr>
		    <td width="70%"><?php echo esc_html__('Enable one attribute swatches On shop/archive pages','color-image-variation-swatches-for-woocommerce'); ?></td>
	    ...
	    <tr id="wcva_shop_swatches_tr" style="<?php if (isset($shop_swatches) && ($shop_swatches == "yes")) { echo 'display:table-row;'; } else { echo 'display:none;'; } ?>">
	        <td width="70%">
	            <?php echo esc_html__('Select atrribute for shop swatches','color-image-variation-swatches-for-woocommerce'); ?>
	        </td>
	        <td width="30%">
	            ...
	            <?php } ?>
	       	        ...
	       	        <img class="help_tip wcva_help_tip" data-tip='<?php echo esc_html__('Swatches of this attribute will be displayed on shop page.','color-image-variation-swatches-for-woocommerce'); ?>' src="<?php echo $helpimg; ?>" height="16" width="16">
	        </td>
	    </tr>
    </table>
</div>