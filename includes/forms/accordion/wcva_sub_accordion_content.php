<div class="accordion-content">
    <table class="widefat" width="100" style="border:none;">
        <tr>
            <td width="30%"><span class="wcvaformfield"><?php echo esc_html__('Display Type','color-image-variation-swatches-for-woocommerce'); ?></span></td>
            <td width="70%">
             	<select idval="<?php echo $attrnumber; ?>_<?php echo $attrsubnumber; ?>" name="coloredvariables[<?php echo $key; ?>][values][<?php echo $value; ?>][type]" id="coloredvariables-<?php echo $attrnumber; ?>-values-<?php echo $attrsubnumber; ?>-type" class="wcvacolororimage">
	                <option value="Color" <?php if ((isset($attrdisplaytype))  && $attrdisplaytype == "Color" ) { echo 'selected'; } ?>><?php echo esc_html__('Color','color-image-variation-swatches-for-woocommerce'); ?></option>
		            <option value="Image" <?php if ((isset($attrdisplaytype)) && $attrdisplaytype == "Image" ) { echo 'selected'; } ?>><?php echo esc_html__('Image','color-image-variation-swatches-for-woocommerce'); ?></option>
				    <option value="textblock" <?php if ((isset($attrdisplaytype)) && $attrdisplaytype == "textblock" ) { echo 'selected'; } ?>><?php echo esc_html__('Text block','color-image-variation-swatches-for-woocommerce'); ?></option>
		        </select>
            </td>
        </tr>
        ...
        <tr class="wcvacolordiv" id="coloredvariables-<?php echo $attrnumber; ?>-values-<?php echo $attrsubnumber; ?>-color"  style="<?php if ((isset($attrdisplaytype)) && (($attrdisplaytype == "Image") || ($attrdisplaytype == "textblock")) ) { echo 'display:none;'; } else { echo 'display:;'; } ?>">
            <td width="30%"> <span class="wcvaformfield"><?php echo esc_html__('Swatch Color','color-image-variation-swatches-for-woocommerce'); ?></span></td>
            <td width="70%">
		...
		<tr class="wcvaimagediv" id="coloredvariables-image" style="<?php if ((isset($attrdisplaytype))  && ($attrdisplaytype == "Image")) { echo 'display:;'; } else { echo 'display:none;'; } ?>">
		    <td width="30%"> <span class="wcvaformfield"><?php echo esc_html__('Swatch Image','color-image-variation-swatches-for-woocommerce'); ?></span></td>
	        <td width="70%">  
	            <div class="facility_thumbnail" id="facility_thumbnail_<?php echo $attrnumber; ?>_<?php echo $attrsubnumber; ?>" style="float:left;">
	                <img src="<?php if (isset($swatchurl) && ($swatchurl != '')) { echo $swatchurl; } else { echo wedd_placeholder_img_src(); }  ?>" width="60px" height="60px" />
	                    <div  class="image-upload-div" idval="<?php echo $attrnumber; ?>_<?php echo $attrsubnumber; ?>" >
					        ...
					        <button type="submit" class="upload_image_button_<?php echo $attrnumber; ?>_<?php echo $attrsubnumber; ?> button"><?php echo esc_html__( 'Upload/Add image', 'color-image-variation-swatches-for-woocommerce' ); ?></button>
					        <button type="submit" class="remove_image_button_<?php echo $attrnumber; ?>_<?php echo $attrsubnumber; ?> button"><?php echo esc_html__( 'Remove image', 'color-image-variation-swatches-for-woocommerce' ); ?></button>
				        </div>
				</div>
	        </td>
	    </tr>
	    ...
	    <tr class="wcvatextblockdiv" id="coloredvariables-textblock" style="<?php if ((isset($attrdisplaytype))  && ($attrdisplaytype == "textblock")) { echo 'display:;'; } else { echo 'display:none;'; } ?>">
		    <td width="30%"> <span class="wcvaformfield"><?php echo esc_html__('Text','color-image-variation-swatches-for-woocommerce'); ?></span></td>
	        <td width="70%">  
		...
		<tr class="wcvahoverimagediv" id="wcvahoverimagediv" style="<?php if (isset($shop_swatches) && ($shop_swatches == "yes")) { echo 'display:;'; } else { echo 'display:none;'; } ?>">
		    <td width="30%"><span class="wcvaformfield"><?php echo esc_html__('Hover Image','color-image-variation-swatches-for-woocommerce'); ?> <img class="help_tip" data-tip='<?php echo esc_html__('This image will replace the product image on swatch hover on shop/archive page.','color-image-variation-swatches-for-woocommerce'); ?>' src="<?php echo $helpimg; ?>" height="16" width="16"></span></td>
            <td width="70%">
                <div class="hover_facility_thumbnail" id="hover_facility_thumbnail_<?php echo $attrnumber; ?>_<?php echo $attrsubnumber; ?>" style="float:left;">
                    <img src="<?php if (isset($hoverurl) && ($hoverurl != '')) { echo $hoverurl; } else { echo wedd_placeholder_img_src(); } ?>" width="60px" height="60px" />
				        <div  class="hover-image-upload-div" idval="<?php echo $attrnumber; ?>_<?php echo $attrsubnumber; ?>" >
					        ...
					        <button type="submit" class="hover_upload_image_button_<?php echo $attrnumber; ?>_<?php echo $attrsubnumber; ?> button"><?php echo esc_html__( 'Upload/Add image', 'color-image-variation-swatches-for-woocommerce' ); ?></button>
					        <button type="submit" class="hover_remove_image_button_<?php echo $attrnumber; ?>_<?php echo $attrsubnumber; ?> button"><?php echo esc_html__( 'Remove image', 'color-image-variation-swatches-for-woocommerce' ); ?></button>
			            </div>
			    </div>
		     </td>
		</tr>
