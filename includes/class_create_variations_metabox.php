...
class wcva_add_colored_variation_metabox {
	 ...
	 */
	   ...
	   ?>
        <a href="#colored_variable_tab_data"><li class="colored_variable_tab show_if_variable" >&nbsp;&nbsp;<?php echo esc_html__('WooSwatches', 'color-image-variation-swatches-for-woocommerce'); ?></a></li>
	   <?php }
